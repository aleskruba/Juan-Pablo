...
{selected === 'Cz' && (
  <>
    ...
    <p>
      <b>🚡 Teleferico & El Peñol Rock:</b> Očekávají vás úžasné výhledy! Vzneseme se vysoko na Teleferico a vyšplháme na El Peñol Rock pro úchvatná panoramata, na která nezapomenete.
    </p>
    <p>
      <b>🍴 Místní restaurace:</b> Pojďme si dopřát Medellínská lahodná sousta! Ochutnejte autentické chutě Kolumbie, od útulných rodinných restaurací až po rušné trhy.
    </p>
    <p>
      <b>🔒 Bezpečný průzkum:</b> Vaše bezpečnost je mou prioritou! Vezmu vás na bezpečná a přívětivá místa, která zajistí bezstarostnou a příjemnou cestu.
    </p>
    <p>
  ...
  <>
    ...
    <p>
      <b>🚡 Teleférico y El Peñol Rock:</b> ¡Te esperan vistas impresionantes! Nos elevaremos en el Teleférico y escalaremos la Roca El Peñol para disfrutar de panoramas asombrosos que no olvidarás.
    </p>
    <p>
      <b>🍴 Restaurantes locales:</b> ¡Disfrutemos de los deliciosos bocados de Medellín! Desde acogedores restaurantes familiares hasta bulliciosos mercados, prueba los auténticos sabores de Colombia.
    </p>
    <p>
      <b>🔒 Exploración segura:</b> ¡Tu seguridad es mi prioridad! Te llevaré a lugares seguros y acogedores, garantizándote un viaje agradable y sin preocupaciones.
    </p>
    <p>
