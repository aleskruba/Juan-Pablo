...
const aboutme= [
  { language:'Us',
    text1: `I was born in ${`<b>Medellin</b>`}, Colombia, and I'm passionate about teaching Spanish. As a native of this beautiful city, I not only offer Spanish lessons but can also be your trusted travel guide, showcasing the wonders of Medellin.`,
    },
  {language:'Es',
    text: `Es`,
    Nací: `Naci en <span className="font-semibold text-teal-600">Medellín</span>, Colombia, y tengo pasión por enseñar español. Como nativo de esta hermosa ciudad, no solo ofrezco lecciones de español, sino que también puedo ser tu guía de viaje de confianza, mostrándote las maravillas de Medellín.
  `},{
  language:'Cz',
  text: `
    Narodil jsem se v <span className="font-semibold text-teal-600">Medellínu</span>, Kolumbie, a vášnivě se věnuji výuce španělštiny. Jako rodilý občan tohoto krásného města nejen nabízím lekce španělštiny, ale mohu být také vaším důvěryhodným průvodcem, který vám představí divy Medellínu.
`
}
]
