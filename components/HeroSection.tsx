...
const HeroSection = () => {
  ...
  return (
    <section id="home">
      <div className="flex flex-col text-center items-center justify-center animate-fadeIn animation-delay-2 my-2 py-16 sm:py-24 md:py-28 md:flex-row md:space-x-4 sm:space-x-0 md:text-left">
