...
const AboutSection = () => {
  ...
  return (
    <section id="about">
      <div className="my-6 pb-12  md:pb-48">
        <h1 className="text-center pt-24 md:pt-20 font-bold text-4xl">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 text-lg">
            {/* Use escaped text content to avoid ESLint errors */}
            {selected === 'Us' && (
              <>
                <p>
            ...
            {selected === 'Es' && (
              <>
                <p>
                  Desde hace un tiempo atrás me dedico a enseñar español, y aprendí que cada alumno es distinto. Por eso, he tenido alumnos con distintas edades y niveles: principiantes, intermedios y avanzados. Si eliges estudiar conmigo, te encontrarás con una clase divertida, dinámica, tranquila y ajustada según tus necesidades.
                </p>
                <p>
                  Si empiezas a aprender español conmigo, notarás rápidamente un aumento significativo de tus habilidades lingüísticas. Soy muy paciente y empático con mis estudiantes porque entiendo perfectamente cómo es aprender otro idioma. ¡Empieza las clases conmigo y podemos hablar sobre tus objetivos y hacer un plan de aprendizaje que te ayudará a lograr los resultados que deseas!
                </p>
                <p>
                  Me encanta hablar, saber de cultura general, y me apasionan los deportes.
                </p>
                <p>
                  Tengo más de 10 años aprendiendo vocabulario del español y, gracias a mi anterior trabajo como conductor de Uber, pude enseñar y mejorar el español de diferentes turistas mediante conversaciones sobre los lugares turísticos de mi ciudad natal (Medellín).
                </p>
              </>
            )}
            {selected === 'Cz' && (
              <>
                <p>
                  Španělštinu učím už nějakou dobu a zjistil jsem, že každý student je jiný. Proto jsem měl studenty různého věku a úrovně: začátečníky, středně pokročilé a pokročilé. Pokud se rozhodnete studovat se mnou, najdete zábavnou, dynamickou a klidnou hodinu přizpůsobenou vašim potřebám.
                </p>
                <p>
                ...
                <p>
                  Učím se španělskou slovní zásobu více než 10 let a díky své předchozí práci řidiče Uberu jsem mohl učit a zlepšovat španělštinu různých turistů prostřednictvím konverzací o turistických místech v mé rodném městě (Medellín).
                </p>
              </>
            )}
          </div>
